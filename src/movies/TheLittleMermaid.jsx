  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258576446-edc1461c-3851-439b-aae7-830dca3429e9.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[4].movieImg}
          movieTitle={moviesApi[4].movieTitle}
          genre={moviesApi[4].genre}
          star={moviesApi[4].star}
          year={moviesApi[4].year}
          month={moviesApi[4].month}
          date={moviesApi[4].date}
          ordinalNumber={moviesApi[4].ordinalNumber}
          moviePosterLandscape={moviesApi[4].moviePosterLandscape}
          moviePoster={moviesApi[4].moviePoster}
          movieDescription={moviesApi[4].movieDescription}
          iframeSrc={moviesApi[4].iframeSrc}
          cast={moviesApi[4].cast}
        />
      </main>
