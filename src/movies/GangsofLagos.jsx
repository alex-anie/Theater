...
function GangsofLagos() {
  return (
    <>
      {/* Background Image */}
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258589079-f270d41e-184a-42cb-aa42-fba5179f1121.png')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[11].movieImg}
          movieTitle={moviesApi[11].movieTitle}
          genre={moviesApi[11].genre}
          star={moviesApi[11].star}
          year={moviesApi[11].year}
          month={moviesApi[11].month}
          date={moviesApi[11].date}
          ordinalNumber={moviesApi[11].ordinalNumber}
          moviePosterLandscape={moviesApi[11].moviePosterLandscape}
          moviePoster={moviesApi[11].moviePoster}
          movieDescription={moviesApi[11].movieDescription}
          iframeSrc={moviesApi[11].iframeSrc}
          cast={moviesApi[11].cast}
        />
      </main>
