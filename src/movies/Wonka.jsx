  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/261222274-cb819498-8e99-4456-80ce-193f86f92fe5.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[23].movieImg}
          movieTitle={moviesApi[23].movieTitle}
          genre={moviesApi[23].genre}
          star={moviesApi[23].star}
          year={moviesApi[23].year}
          month={moviesApi[23].month}
          date={moviesApi[23].date}
          ordinalNumber={moviesApi[23].ordinalNumber}
          moviePosterLandscape={moviesApi[23].moviePosterLandscape}
          moviePoster={moviesApi[23].moviePoster}
          movieDescription={moviesApi[23].movieDescription}
          iframeSrc={moviesApi[23].iframeSrc}
          cast={moviesApi[23].cast}
        />
      </main>
