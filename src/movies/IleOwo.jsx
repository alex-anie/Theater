  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258593891-dbf1b25c-77b3-4cb0-abfa-9b7bda83d17c.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[13].movieImg}
          movieTitle={moviesApi[13].movieTitle}
          genre={moviesApi[13].genre}
          star={moviesApi[13].star}
          year={moviesApi[13].year}
          month={moviesApi[13].month}
          date={moviesApi[13].date}
          ordinalNumber={moviesApi[13].ordinalNumber}
          moviePosterLandscape={moviesApi[13].moviePosterLandscape}
          moviePoster={moviesApi[13].moviePoster}
          movieDescription={moviesApi[13].movieDescription}
          iframeSrc={moviesApi[13].iframeSrc}
          cast={moviesApi[13].cast}
        />
      </main>
