...
function HappinessforBeginners() {
  return (
    <>
      {/* Background Image */}
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258601870-006f34a8-5d77-4e60-9435-59151ab8e7ea.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[14].movieImg}
          movieTitle={moviesApi[14].movieTitle}
          genre={moviesApi[14].genre}
          star={moviesApi[14].star}
          year={moviesApi[14].year}
          month={moviesApi[14].month}
          date={moviesApi[14].date}
          ordinalNumber={moviesApi[14].ordinalNumber}
          moviePosterLandscape={moviesApi[14].moviePosterLandscape}
          moviePoster={moviesApi[14].moviePoster}
          movieDescription={moviesApi[14].movieDescription}
          iframeSrc={moviesApi[14].iframeSrc}
          cast={moviesApi[14].cast}
        />
      </main>
...
export default HappinessforBeginners;
