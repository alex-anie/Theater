  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258656739-2a11cf0d-7a37-4af3-8b15-b56d968803f2.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[18].movieImg}
          movieTitle={moviesApi[18].movieTitle}
          genre={moviesApi[18].genre}
          star={moviesApi[18].star}
          year={moviesApi[18].year}
          month={moviesApi[18].month}
          date={moviesApi[18].date}
          ordinalNumber={moviesApi[18].ordinalNumber}
          moviePosterLandscape={moviesApi[18].moviePosterLandscape}
          moviePoster={moviesApi[18].moviePoster}
          movieDescription={moviesApi[18].movieDescription}
          iframeSrc={moviesApi[18].iframeSrc}
          cast={moviesApi[18].cast}
        />
      </main>
