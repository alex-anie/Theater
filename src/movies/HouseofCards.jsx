  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/261317448-8320d775-c6ab-44d9-8f2e-aae220819a07.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[48].movieImg}
          movieTitle={moviesApi[48].movieTitle}
          genre={moviesApi[48].genre}
          star={moviesApi[48].star}
          year={moviesApi[48].releaseYear}
          month={moviesApi[48].type}
          date={moviesApi[48].seasons}
          moviePosterLandscape={moviesApi[48].moviePosterLandscape}
          moviePoster={moviesApi[48].moviePoster}
          movieDescription={moviesApi[48].movieDescription}
          iframeSrc={moviesApi[48].iframeSrc}
          cast={moviesApi[48].cast}
        />
      </main>
