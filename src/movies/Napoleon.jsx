  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258572386-91b32a56-13a4-4d74-bea5-b6f11a6ab533.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[1].movieImg}
          movieTitle={moviesApi[1].movieTitle}
          genre={moviesApi[1].genre}
          star={moviesApi[1].star}
          year={moviesApi[1].year}
          month={moviesApi[1].month}
          date={moviesApi[1].date}
          ordinalNumber={moviesApi[1].ordinalNumber}
          moviePosterLandscape={moviesApi[1].moviePosterLandscape}
          moviePoster={moviesApi[1].moviePoster}
          movieDescription={moviesApi[1].movieDescription}
          iframeSrc={moviesApi[1].iframeSrc}
          cast={moviesApi[1].cast}
        />
      </main>
