...
function Mavka() {
  return (
    <>
      ...
      <main>
        <LandingPage
          movieImg={moviesApi[39].movieImg}
          movieTitle={moviesApi[39].movieTitle}
          genre={moviesApi[39].genre}
          star={moviesApi[39].star}
          year={moviesApi[39].year}
          month={moviesApi[39].month}
          date={moviesApi[39].date}
          moviePosterLandscape={moviesApi[39].moviePosterLandscape}
          moviePoster={moviesApi[39].moviePoster}
          movieDescription={moviesApi[39].movieDescription}
          iframeSrc={moviesApi[39].iframeSrc}
          cast={moviesApi[39].cast}
        />
      </main>
