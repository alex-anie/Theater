...
function ShawshankRedemption() {
  return (
    <>
      {/* Background Image */}
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/261232229-b4a7e059-cf5e-4dbc-a4b1-bc1791d13bdc.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[26].movieImg}
          movieTitle={moviesApi[26].movieTitle}
          genre={moviesApi[26].genre}
          star={moviesApi[26].star}
          year={moviesApi[26].year}
          month={moviesApi[26].month}
          date={moviesApi[26].date}
          ordinalNumber={moviesApi[26].ordinalNumber}
          moviePosterLandscape={moviesApi[26].moviePosterLandscape}
          moviePoster={moviesApi[26].moviePoster}
          movieDescription={moviesApi[26].movieDescription}
          iframeSrc={moviesApi[26].iframeSrc}
          cast={moviesApi[26].cast}
        />
      </main>
...
export default ShawshankRedemption;
