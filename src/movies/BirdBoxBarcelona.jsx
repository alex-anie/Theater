...
function BirdBoxBarcelona() {
  return (
    <>
      {/* Background Image */}
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258584820-cc43adf2-fac8-4b3a-8c67-af62d7b534ec.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[7].movieImg}
          movieTitle={moviesApi[7].movieTitle}
          genre={moviesApi[7].genre}
          star={moviesApi[7].star}
          year={moviesApi[7].year}
          month={moviesApi[7].month}
          date={moviesApi[7].date}
          ordinalNumber={moviesApi[7].ordinalNumber}
          moviePosterLandscape={moviesApi[7].moviePosterLandscape}
          moviePoster={moviesApi[7].moviePoster}
          movieDescription={moviesApi[7].movieDescription}
          iframeSrc={moviesApi[7].iframeSrc}
          cast={moviesApi[7].cast}
        />
      </main>
...
export default BirdBoxBarcelona;
