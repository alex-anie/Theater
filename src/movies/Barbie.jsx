  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258533184-0df09cec-bda3-43b7-8f50-7f84decec183.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-br from-black "></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[0].movieImg}
          movieTitle={moviesApi[0].movieTitle}
          genre={moviesApi[0].genre}
          star={moviesApi[0].star}
          year={moviesApi[0].year}
          month={moviesApi[0].month}
          date={moviesApi[0].date}
          ordinalNumber={moviesApi[0].ordinalNumber}
          moviePosterLandscape={moviesApi[0].moviePosterLandscape}
          moviePoster={moviesApi[0].moviePoster}
          movieDescription={moviesApi[0].movieDescription}
          iframeSrc={moviesApi[0].iframeSrc}
          cast={moviesApi[0].cast}
        />
      </main>
