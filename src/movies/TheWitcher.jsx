  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/261302016-1e9ccdd6-1e33-4981-a880-0017dc6b1d65.png')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[45].movieImg}
          movieTitle={moviesApi[45].movieTitle}
          genre={moviesApi[45].genre}
          star={moviesApi[45].star}
          year={moviesApi[45].releaseYear}
          month={moviesApi[45].type}
          date={moviesApi[45].seasons}
          moviePosterLandscape={moviesApi[45].moviePosterLandscape}
          moviePoster={moviesApi[45].moviePoster}
          movieDescription={moviesApi[45].movieDescription}
          iframeSrc={moviesApi[45].iframeSrc}
          cast={moviesApi[45].cast}
        />
      </main>
