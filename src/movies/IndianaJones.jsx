  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/261225900-f67f2178-a974-4d29-87ba-1ac4db510dfb.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[24].movieImg}
          movieTitle={moviesApi[24].movieTitle}
          genre={moviesApi[24].genre}
          star={moviesApi[24].star}
          year={moviesApi[24].year}
          month={moviesApi[24].month}
          date={moviesApi[24].date}
          ordinalNumber={moviesApi[24].ordinalNumber}
          moviePosterLandscape={moviesApi[24].moviePosterLandscape}
          moviePoster={moviesApi[24].moviePoster}
          movieDescription={moviesApi[24].movieDescription}
          iframeSrc={moviesApi[24].iframeSrc}
          cast={moviesApi[24].cast}
        />
      </main>
