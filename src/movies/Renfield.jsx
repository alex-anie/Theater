  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258660854-203c5bd0-e5ee-4eee-8c47-a27c48af72b4.jpeg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[20].movieImg}
          movieTitle={moviesApi[20].movieTitle}
          genre={moviesApi[20].genre}
          star={moviesApi[20].star}
          year={moviesApi[20].year}
          month={moviesApi[20].month}
          date={moviesApi[20].date}
          ordinalNumber={moviesApi[20].ordinalNumber}
          moviePosterLandscape={moviesApi[20].moviePosterLandscape}
          moviePoster={moviesApi[20].moviePoster}
          movieDescription={moviesApi[20].movieDescription}
          iframeSrc={moviesApi[20].iframeSrc}
          cast={moviesApi[20].cast}
        />
      </main>
