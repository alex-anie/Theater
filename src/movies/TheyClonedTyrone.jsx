...
function TheyClonedTyrone() {
  return (
    <>
      {/* Background Image */}
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258585918-ba6ba14d-87ef-4761-9553-60fe42e06adc.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[8].movieImg}
          movieTitle={moviesApi[8].movieTitle}
          genre={moviesApi[8].genre}
          star={moviesApi[8].star}
          year={moviesApi[8].year}
          month={moviesApi[8].month}
          date={moviesApi[8].date}
          ordinalNumber={moviesApi[8].ordinalNumber}
          moviePosterLandscape={moviesApi[8].moviePosterLandscape}
          moviePoster={moviesApi[8].moviePoster}
          movieDescription={moviesApi[8].movieDescription}
          iframeSrc={moviesApi[8].iframeSrc}
          cast={moviesApi[8].cast}
        />
      </main>
...
export default TheyClonedTyrone;
