  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258592444-0fe1fb4d-cd53-4c18-840b-30552f0c6265.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[12].movieImg}
          movieTitle={moviesApi[12].movieTitle}
          genre={moviesApi[12].genre}
          star={moviesApi[12].star}
          year={moviesApi[12].year}
          month={moviesApi[12].month}
          date={moviesApi[12].date}
          ordinalNumber={moviesApi[12].ordinalNumber}
          moviePosterLandscape={moviesApi[12].moviePosterLandscape}
          moviePoster={moviesApi[12].moviePoster}
          movieDescription={moviesApi[12].movieDescription}
          iframeSrc={moviesApi[12].iframeSrc}
          cast={moviesApi[12].cast}
        />
      </main>
