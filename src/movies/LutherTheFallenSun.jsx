...
function LutherTheFallenSun() {
  return (
    <>
      {/* Background Image */}
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258654199-6058f97f-31d4-46de-be5e-c14012ebb449.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[15].movieImg}
          movieTitle={moviesApi[15].movieTitle}
          genre={moviesApi[15].genre}
          star={moviesApi[15].star}
          year={moviesApi[15].year}
          month={moviesApi[15].month}
          date={moviesApi[15].date}
          ordinalNumber={moviesApi[15].ordinalNumber}
          moviePosterLandscape={moviesApi[15].moviePosterLandscape}
          moviePoster={moviesApi[15].moviePoster}
          movieDescription={moviesApi[15].movieDescription}
          iframeSrc={moviesApi[15].iframeSrc}
          cast={moviesApi[15].cast}
        />
      </main>
...
export default LutherTheFallenSun;
