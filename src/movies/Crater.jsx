  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/261228416-a0c154ae-f639-4712-8ad3-d10848da8c6c.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[25].movieImg}
          movieTitle={moviesApi[25].movieTitle}
          genre={moviesApi[25].genre}
          star={moviesApi[25].star}
          year={moviesApi[25].year}
          month={moviesApi[25].month}
          date={moviesApi[25].date}
          ordinalNumber={moviesApi[25].ordinalNumber}
          moviePosterLandscape={moviesApi[25].moviePosterLandscape}
          moviePoster={moviesApi[25].moviePoster}
          movieDescription={moviesApi[25].movieDescription}
          iframeSrc={moviesApi[25].iframeSrc}
          cast={moviesApi[25].cast}
        />
      </main>
