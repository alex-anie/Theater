  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[21].movieImg}
          movieTitle={moviesApi[21].movieTitle}
          genre={moviesApi[21].genre}
          star={moviesApi[21].star}
          year={moviesApi[21].year}
          month={moviesApi[21].month}
          date={moviesApi[21].date}
          ordinalNumber={moviesApi[21].ordinalNumber}
          moviePosterLandscape={moviesApi[21].moviePosterLandscape}
          moviePoster={moviesApi[21].moviePoster}
          movieDescription={moviesApi[21].movieDescription}
          iframeSrc={moviesApi[21].iframeSrc}
          cast={moviesApi[21].cast}
        />
      </main>
