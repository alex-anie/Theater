  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258658193-8fbe8f26-8439-44b0-86be-b809f0b48012.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[19].movieImg}
          movieTitle={moviesApi[19].movieTitle}
          genre={moviesApi[19].genre}
          star={moviesApi[19].star}
          year={moviesApi[19].year}
          month={moviesApi[19].month}
          date={moviesApi[19].date}
          ordinalNumber={moviesApi[19].ordinalNumber}
          moviePosterLandscape={moviesApi[19].moviePosterLandscape}
          moviePoster={moviesApi[19].moviePoster}
          movieDescription={moviesApi[19].movieDescription}
          iframeSrc={moviesApi[19].iframeSrc}
          cast={moviesApi[19].cast}
        />
      </main>
