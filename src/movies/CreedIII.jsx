  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258586891-a413b12c-ee8d-4cc8-8a98-7324d1026d8d.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[9].movieImg}
          movieTitle={moviesApi[9].movieTitle}
          genre={moviesApi[9].genre}
          star={moviesApi[9].star}
          year={moviesApi[9].year}
          month={moviesApi[9].month}
          date={moviesApi[9].date}
          ordinalNumber={moviesApi[9].ordinalNumber}
          moviePosterLandscape={moviesApi[9].moviePosterLandscape}
          moviePoster={moviesApi[9].moviePoster}
          movieDescription={moviesApi[9].movieDescription}
          iframeSrc={moviesApi[9].iframeSrc}
          cast={moviesApi[9].cast}
        />
      </main>
