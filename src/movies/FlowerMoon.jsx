  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/261240312-9ab0169c-1451-4bab-9f6a-975d92b9c23c.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[28].movieImg}
          movieTitle={moviesApi[28].movieTitle}
          genre={moviesApi[28].genre}
          star={moviesApi[28].star}
          year={moviesApi[28].year}
          month={moviesApi[28].month}
          date={moviesApi[28].date}
          ordinalNumber={moviesApi[28].ordinalNumber}
          moviePosterLandscape={moviesApi[28].moviePosterLandscape}
          moviePoster={moviesApi[28].moviePoster}
          movieDescription={moviesApi[28].movieDescription}
          iframeSrc={moviesApi[28].iframeSrc}
          cast={moviesApi[28].cast}
        />
      </main>
