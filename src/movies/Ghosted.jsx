  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258577132-735bec03-d2a7-4aec-a062-9bbdc805bfc4.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[29].movieImg}
          movieTitle={moviesApi[29].movieTitle}
          genre={moviesApi[29].genre}
          star={moviesApi[29].star}
          year={moviesApi[29].year}
          month={moviesApi[29].month}
          date={moviesApi[29].date}
          ordinalNumber={moviesApi[29].ordinalNumber}
          moviePosterLandscape={moviesApi[29].moviePosterLandscape}
          moviePoster={moviesApi[29].moviePoster}
          movieDescription={moviesApi[29].movieDescription}
          iframeSrc={moviesApi[29].iframeSrc}
          cast={moviesApi[29].cast}
        />
      </main>
