  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258655163-ebb4f876-960d-4aaa-824e-81791baf0e55.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[16].movieImg}
          movieTitle={moviesApi[16].movieTitle}
          genre={moviesApi[16].genre}
          star={moviesApi[16].star}
          year={moviesApi[16].year}
          month={moviesApi[16].month}
          date={moviesApi[16].date}
          ordinalNumber={moviesApi[16].ordinalNumber}
          moviePosterLandscape={moviesApi[16].moviePosterLandscape}
          moviePoster={moviesApi[16].moviePoster}
          movieDescription={moviesApi[16].movieDescription}
          iframeSrc={moviesApi[16].iframeSrc}
          cast={moviesApi[16].cast}
        />
      </main>
