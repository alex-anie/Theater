...
function TheMonkeyKing() {
  return (
    <>
      {/* Background Image */}
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/258584788-45a67897-507f-4397-9fc1-3d61a18eb614.jpg')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[30].movieImg}
          movieTitle={moviesApi[30].movieTitle}
          genre={moviesApi[30].genre}
          star={moviesApi[30].star}
          year={moviesApi[30].year}
          month={moviesApi[30].month}
          date={moviesApi[30].date}
          ordinalNumber={moviesApi[30].ordinalNumber}
          moviePosterLandscape={moviesApi[30].moviePosterLandscape}
          moviePoster={moviesApi[30].moviePoster}
          movieDescription={moviesApi[30].movieDescription}
          iframeSrc={moviesApi[30].iframeSrc}
          cast={moviesApi[30].cast}
        />
      </main>
