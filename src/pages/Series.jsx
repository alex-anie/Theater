  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden">
        {/* Desktop */}
        <div className="[background-image:url('https://user-images.githubusercontent.com/78242022/261254701-ebe52184-4689-44bf-8be1-cbc27682d7e6.png')] [background-size:cover] [background-position:center_center] [background-repeat:no-repeat] w-full h-full before:content-[''] before:w-full before:h-full before:block before:-inset-0 before:bg-gradient-to-tr before:from-black from-50deg to-90%"></div>
      </main>

      {/* Text and YouTube Iframe*/}
      <main>
        <LandingPage
          movieImg={moviesApi[40].movieImg}
          movieTitle={moviesApi[40].movieTitle}
          genre={moviesApi[40].genre}
          star={moviesApi[40].star}
          year={moviesApi[40].releaseYear}
          month={moviesApi[40].type}
          date={moviesApi[40].seasons}
          moviePosterLandscape={moviesApi[40].moviePosterLandscape}
          moviePoster={moviesApi[40].moviePoster}
          movieDescription={moviesApi[40].movieDescription}
          iframeSrc={moviesApi[40].iframeSrc}
          cast={moviesApi[40].cast}
        />
      </main>
